---
description: 오늘은 Vault Auto Unseal이다.
---
...
* 다음 링크 상의 정보를 참고하여 작업
  * [https://learn.hashicorp.com/tutorials/vault/autounseal-transit](https://learn.hashicorp.com/tutorials/vault/autounseal-transit)
* 관련 자료
  * [https://learn.hashicorp.com/tutorials/vault/pattern-auto-unseal?in=vault/recommended-patterns](https://learn.hashicorp.com/tutorials/vault/pattern-auto-unseal?in=vault/recommended-patterns)
  * [https://www.vaultproject.io/docs/concepts/seal#seal-migration](https://www.vaultproject.io/docs/concepts/seal#seal-migration)

#### 1. HCP Vault 구성

작업 시 VAULT\_ADDR, VAULT\_TOKEN, VAULT\_NAMESPACE는 HCP Vault의 클러스터와 네임 스페이스를 사용할 수 있도록 설정할 것.
...
$ cat ./c1/vault_1_auto.hcl
  storage "raft" {
      path = "/Users/jsp/code/playground/vault-cluster/vault_1/raft"
      nod_id = "raft_node_1"
  }
  ...
  license_path="/Users/jsp/code/playground/vault-cluster/c1/vault.hclic"
...
# Vault 서버 기동
$ vault server -config=/Users/jsp/code/playground/vault-cluster/c1/vault_1_auto.hcl
```

#### 3. 잠금 키 이관

다른 CLI 창에서 다음 명령어를 수행. 이 때, VAULT\_ADDR은 대상 Vault 서버로 설정. VAULT\_TOKEN을 설정할 필요가 없음.
...
2022-06-24T17:42:58.735+0900 [INFO]  core: using autoloaded license: license="{\"license_id\":\"2b19380d-c0f5-5527-a099-f1b19ae54cc7\",\"customer_id\":\"35f67391-7ab5-ed31-d285-9bde9ee79e8e\",\"installation_id\":\"*\",\"issue_time\":\"2021-10-13T10:47:54.824801629Z\",\"start_time\":\"2021-10-13T00:00:00Z\",\"expiration_time\":\"2022-10-13T23:59:59.999Z\",\"flags\":{\"modules\":[\"multi-dc-scale\",\"governance-policy\",\"advanced-data-protection-key-management\",\"advanced-data-protection-transform\"]},\"features\":[\"HSM\",\"Performance Replication\",\"DR Replication\",\"MFA\",\"Sentinel\",\"Seal Wrapping\",\"Control Groups\",\"Performance Standby\",\"Namespaces\",\"KMIP\",\"Entropy Augmentation\",\"Transform Secrets Engine\",\"Lease Count Quotas\",\"Key Management Secrets Engine\",\"Automated Snapshots\",\"Key Management Transparent Data Encryption\"],\"performance_standby_count\":9999}"
